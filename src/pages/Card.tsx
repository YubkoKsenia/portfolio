      ...
      <main>
        <section className="section">
          ...
          <ul>
            ...
            <li>Creating reliable web-applications with JavaScript/TypeScript and React</li>
        ...
        <section className="section">
          ...
          <p>Faculty of Digital Technologies and Cybersecurity, Applied Mathematics and IT</p>
        </section>
        ...
        <section className="section">
          ...
          <article className="experience">
            <h3>UH Photo</h3>
            <p><strong>Pet Project</strong> (Feb 2023 – May 2023)</p>
            <p>
              A web-application for storing photos with semantic search capabilities. You can search
              for similar photos in the database or search based on textual descriptions.
            </p>
            <h4>Tech Stack:</h4>
            <ul>
